...
if MsgText[1] == "تفعيل اطربنا" then
  if not msg.Director then return "•هذا الامر يخص { المطور,المالك,المنشئ,المدير } فقط  \n✿" end
  if not redis:get(omar..'omar'..msg.chat_id_)  then
  return '• تم تفعيل امر اطربنا مسبقا'
  else
  redis:del(omar.."omar"..msg.chat_id_)
  return '• تم تفعيل امر اطربنا'
  end
